...
(function () {
  ...
  var DICT = {
    en: {
      ...
      "portfolio.lead": "Working systems, each mapped to a line in the job description. Repos are public.",
      "pf.repo.link": "View repository →",
      "pf.5.cat": "Язык",
      "pf.5.t": "Russian text-analysis pipeline",
      "pf.5.d": "Standard-library-only NLP for Russian material: corpus ingestion, tokenization, frequency and KWIC concordance extraction, self-contained HTML report. Runs anywhere Python 3.8+ does — the constraint real analysis tools face.",
      "pf.5.tags": "python · nlp · concordance · stdlib-only",
      "pf.5.status": "In use",
      "pf.6.cat": "Сети",
      "pf.6.t": "Synthetic network graph lab",
      "pf.6.d": "Seeded synthetic networks (planted communities, preferential, small-world) → degree distribution, edge-betweenness bridges, label-propagation communities → self-contained SVG report. Bridges render in red to train the high-value-node instinct.",
      "pf.6.tags": "networkx · graphs · visualization",
      "pf.6.status": "In use",
      "pf.7.cat": "OSINT",
      "pf.7.t": "Open-source collection workflow",
      "pf.7.d": "Documented capture-to-product methodology with an executable collector: query-syntax library, a 5-axis source-evaluation rubric scored into every provenance sidecar, and rate-limited, passive-first collection.",
      "pf.7.tags": "osint · methodology · provenance",
      "pf.7.status": "In use",
      "pf.8.cat": "Отчётность",
      "pf.8.t": "Automated reporting pipeline",
      "pf.8.d": "Scheduled collection feeding a templated intelligence product — collection → graph analysis → report, automated end to end. Wired to the collection workflow and the graph lab; systemd timer included.",
      "pf.8.tags": "automation · reporting · systemd",
      "pf.8.status": "In use",
    ...
    ru: {
      ...
      "portfolio.eyebrow": "Built things · Построенные вещи",
      "portfolio.lead": "Работающие системы — каждая привязана к строке в описании вакансии. Репозитории открыты.",
      "pf.repo.link": "Открыть репозиторий →",
      "pf.5.cat": "Язык",
      "pf.5.t": "Пайплайн анализа русскоязычных текстов",
      "pf.5.d": "NLP для русских материалов на одной стандартной библиотеке: загрузка корпуса, токенизация, частотность и конкорданс (KWIC), самодостаточный HTML-отчёт. Работает везде, где есть Python 3.8+ — то же ограничение, что у реальных инструментов анализа.",
      "pf.5.tags": "python · nlp · конкорданс · stdlib-only",
      "pf.5.status": "В использовании",
      "pf.6.cat": "Сети",
      "pf.6.t": "Лаборатория синтетических сетевых графов",
      "pf.6.d": "Синтетические сети с фиксированным сидом (сообщества, преимущественное присоединение, тесный мир) → распределение степеней, мосты по промежуточности рёбер, сообщества через label propagation → самодостаточный SVG-отчёт. Мосты — красным: тренирует инстинкт на ценные узлы.",
      "pf.6.tags": "networkx · графы · визуализация",
      "pf.6.status": "В использовании",
      "pf.7.cat": "OSINT",
      "pf.7.t": "Процесс сбора из открытых источников",
      "pf.7.d": "Документированная методология «сбор → продукт» с исполняемым коллектором: библиотека поисковых запросов, 5-осевая рубрика оценки источников, вписанная в каждый provenance-файл, и пассивный сбор с ограничением темпа.",
      "pf.7.tags": "osint · методология · provenance",
      "pf.7.status": "В использовании",
      "pf.8.cat": "Отчётность",
      "pf.8.t": "Автоматизированный пайплайн отчётности",
      "pf.8.d": "Плановый сбор, питающий шаблонный разведпродукт: сбор → анализ графа → отчёт, автоматизировано от начала до конца. Подключён к процессу сбора и к графовой лаборатории; systemd-таймер в комплекте.",
      "pf.8.tags": "автоматизация · отчётность · systemd",
      "pf.8.status": "В использовании",
