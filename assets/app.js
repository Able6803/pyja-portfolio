...
(function () {
  ...
  var DICT = {
    en: {
      ...
      "exp.2.b1": "Led a multi-discipline Analysis & Exploitation Team through the Russia–Ukraine conflict; pioneered combined linguist-analyst tradecraft and authored the flight's roadmap. Conducted continuity-of-operations training at two additional sites.",
      "exp.2.b2": "Built a production-metrics tool for a 31-member team and codified 300 high-priority targets — guaranteed 100% target tracking.",
      "exp.2.b3": "Trained six analysts and wrote the flight's first SOP, lifting team output 600%; selected for two DCGS TDYs, training SIGINT techniques to 125 members.",
      "exp.3.t": "Target Digital Network Analyst & Reporter",
      "exp.3.w": "U.S. Air Force, 303d IS — Korea · 2020–2021",
      "exp.3.b1": "Team lead for target development and reporting; headed a 10-member joint work center that published 77 reports and closed 394 outstanding queries.",
      "exp.3.b2": "Audited an AI translation tool — quality-checked 1,000 terms — advancing the algorithm for DoD-wide language operations. Supported hostage recovery operations.",
      "exp.3.b3": "Authored 30 reports and established target TTPs that enabled a $5.7M seizure; led a financial-intelligence cell drafting 72 sanctions-evasion reports.",
      "exp.4.t": "Target Analyst Developer & Reporter",
      "exp.4.w": "U.S. Air Force, 392d IS — Hawaii · 2017–2020",
      "exp.4.b1": "Triple-hatted as network, reporting, and geospatial analyst — produced 10% of a 55-member team's output during the maximum-pressure campaign.",
      "exp.4.b2": "Led a reporting cell authoring 300+ cross-functional reports, satisfying 1,000 intelligence needs across six partner organizations.",
      "exp.4.b3": "Pursued 50+ hours of Python programming and automated communications analysis, cutting 80 man-hours and lifting team productivity 20%.",
      "exp.5.t": "Independent technical practice",
      "exp.5.w": "2019–present",
    ...
    ru: {
      ...
      "exp.2.b1": "Руководство междисциплинарной группой анализа и эксплуатации во время конфликта Россия–Украина; первопроходец совместных методик лингвистов и аналитиков — автор дорожной карты подразделения. Учения по непрерывности операций (COOP) на двух площадках.",
      "exp.2.b2": "Инструмент метрик производства для команды из 31 человека; систематизированы 300 приоритетных целей — стопроцентное отслеживание.",
      "exp.2.b3": "Обучены шесть аналитиков, написан первый SOP подразделения — рост производительности на 600%; две командировки DCGS: обучены 125 специалистов методикам SIGINT.",
      "exp.3.t": "Аналитик цифровых сетей и составитель отчётов",
      "exp.3.w": "ВВС США, 303d IS — Корея · 2020–2021",
      "exp.3.b1": "Лидер команды разработки целей и отчётности; совместный рабочий центр из 10 человек: 77 отчётов, 394 закрытых запроса.",
      "exp.3.b2": "Аудит ИИ-инструмента перевода: контроль качества 1000 терминов — алгоритм улучшен для языковых операций уровня всего ведомства. Поддержка операций по освобождению заложников.",
      "exp.3.b3": "30 отчётов и методики целеуказания, позволившие провести конфискацию на $5,7 млн; ячейка финансовой разведки — 72 отчёта о схемах обхода санкций.",
      "exp.4.t": "Разработчик целей и составитель отчётов",
      "exp.4.w": "ВВС США, 392d IS — Гавайи · 2017–2020",
      "exp.4.b1": "Совмещение трёх ролей — сетевого, отчётного и геопространственного аналитика: 10% продукции команды из 55 человек в период кампании максимального давления.",
      "exp.4.b2": "Руководство ячейкой отчётности: 300+ межфункциональных отчётов, 1000 закрытых разведпотребностей шести организаций-партнёров.",
      "exp.4.b3": "50+ часов изучения Python; автоматизация анализа коммуникаций: −80 человеко-часов, +20% производительности команды.",
